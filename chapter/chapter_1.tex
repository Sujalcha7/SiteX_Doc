...
\begin{itemize}
	\item {To design SiteX, a data-driven location intelligence system that leverages an XGBoost Regressor model on geospatial POI features to predict suitability scores and risk levels for optimal franchised cafe site selection.}
\end{itemize}
...
In the ongoing $8^{th}$ semester, our focus will shift towards refining the existing architecture, enhancing the system's scalability, expanding our datasets, conducting real-world user testing, and delivering the final, full-featured version of the platform.