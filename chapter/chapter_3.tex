...
\begin{enumerate}
    ...
    \item[\textbf{b.}] \textbf{Performance / Latency:} The system must return a full analysis (score, heatmap data, etc.) within a few seconds (e.g., < 1 seconds) of a user selecting a location to ensure a responsive and fluid user experience.
