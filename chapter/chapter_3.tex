...
The functional requirements define the specific behaviors and capabilities of the   SiteX platform. The system must:
...
\begin{enumerate}
    ...
    \item[\textbf{b.}] \textbf{Dynamic Heatmap Generation:} Generate and display a personalized "Opportunity Zone" heatmap on an interactive map with high-potential areas tailored to the user's specific business profile.
