...
\end{figure}\
\noindent
\ignorespaces The use case diagram for the Predictive Site Selection System illustrates interactions between the system and its users: Business Owner and Data Analyst. Key components include:
\begin{itemize}
