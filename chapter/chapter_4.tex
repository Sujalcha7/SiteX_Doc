...
\begin{itemize}
    ...
    \item \textbf{Neighborhoods Layer:} GIS polygons defining commercial zones across Bhaktapur, enriched with demographic proxies derived from POI density analysis and real estate data.
\end{itemize}
