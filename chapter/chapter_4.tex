...
The project's foundation is a high-quality, multi-layered geographic dataset. This "Master Dataset" will be built by aggregating data from public online sources and manual field verification within the core commercial areas. The primary tool for this phase will be the open-source Geographic Information System (GIS) software, \texttt{QGIS}. Data is collected and organized into a relational structure with four primary layers:
...
\begin{itemize}
    ...
    \item \textbf{Neighborhoods Layer:} GIS polygons defining different zones across the area. This layer is enriched with \textbf{demographic proxies} (e.g., average rent per square foot, student service density) derived from scraped real estate data and POI density analysis.
