...
Selecting the right location is one of the riskiest decisions for new entrepreneurs, and many rely on intuition or limited information, which often leads to business failure. This project proposes a Location Intelligence and Decision Support Platform that helps small and medium-sized businesses in Nepal make better, data-driven site selection decisions. The system first understands the entrepreneur’s specific business goals, such as the type of cafe or target customers, along with budget and property needs. It then analyzes competitor locations, nearby points of interest, and neighborhood characteristics using geospatial data and an XGBoost-based machine learning model to generate an “Opportunity Zone” heatmap and a personalized Suitability Score for any location. To ensure transparency and usability, the platform explains why a location scores high or low and provides additional tools such as trade area analysis, competitor insights, and information on available rental properties. Overall, the system bridges the gap between analysis and real-world action, making advanced data science accessible and helping entrepreneurs significantly reduce the risk of starting a new business.\\\\
